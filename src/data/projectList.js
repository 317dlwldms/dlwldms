...
import homeImg0 from "asset/images/work/web/0_imghome.png";
import homeImg1 from "asset/images/work/web/1_imghome.png";
import homeImg2 from "asset/images/work/web/2_imghome.png";
import homeImg3 from "asset/images/work/web/3_imghome.png";
...
export const projectList = [
    ...
    },
    {
        ...
        keyFeatures: { label : "Geolocation API, Weather API,", text: <div className="kF_text"><p><span>·</span>사용자의 위치에 따라 현재 날씨를 가져오고, 권한이 없는 경우에도 서비스가 동작하도록 예외 처리를 두어 구현하였습니다.</p></div>},
        github: "",
