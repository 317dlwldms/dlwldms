...
export const projectList = [
    {
        ...
        keyFeatures: [
            { label : "Geolocation API, Weather API", text: "사용자의 위치에 따라 현재 날씨를 가져오고, 권한이 없는 경우에도 서비스가 동작하도록 예외 처리를 두어 구현하였습니다. "},
            { label : "Spotify API", text: "위치와 날씨를 고려해 상황에 맞는 플레이리스트를 추천함"},
        ],
        github: "dd",
        figma: "",
        notion: "dd",
    ...
    },
    {
        ...
        keyFeatures: [
            { label : "Geolocation API, Weather API", text: "- 사용자의 위치에 따라 현재 날씨를 가져오고, 권한이 없는 경우에도 서비스가 동작하도록 예외 처리를 두어 구현하였습니다. "},
            { label : "Spotify API", text: "- 위치와 날씨를 반영하여 상황에 맞는 플레이리스트를 추천함"},
        ],
        github: "",
        figma: "dd",
        notion: "dd",
