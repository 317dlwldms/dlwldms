        ...
        <div className="Header on">
            ...
            <ul className="Nav">
                ...
                <li>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <path d="M14.6667 4.66666L8.67271 8.48466C8.4693 8.6028 8.23827 8.66503 8.00304 8.66503C7.76782 8.66503 7.53678 8.6028 7.33337 8.48466L1.33337 4.66666M2.66671 2.66666H13.3334C14.0698 2.66666 14.6667 3.26361 14.6667 3.99999V12C14.6667 12.7364 14.0698 13.3333 13.3334 13.3333H2.66671C1.93033 13.3333 1.33337 12.7364 1.33337 12V3.99999C1.33337 3.26361 1.93033 2.66666 2.66671 2.66666Z" stroke="#555" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </div>
                    <p>Contact</p>
                </li>
